...
import (
	...
	"github.com/mohammadshabab/practice_Go/fixMemoryLeak/api"
)
...
func main() {
	...
	//fmt.Println("lent ", len(millions)-10)

	l10 := make([]int, 0, 10)
	//l10 := make([]int, 10)
	l10 = append(l10, millions[len(millions)-10:]...)
	//copy(l10, millions[len(millions)-10:])
	fmt.Printf("\nl10 10 elements: %d\n\n", l10)

	millions = l10
	fmt.Printf("\nmillions 10 elements: %d\n\n", millions)
	//fmt.Printf("\nLast 10 elements: %d\n\n", last10)
